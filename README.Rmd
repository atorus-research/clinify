...
[![R build status](https://github.com/atorus-research/clinify/workflows/R-CMD-check/badge.svg)](https://github.com/atorus-research/clinify/actions?workflow=R-CMD-check)
<!-- badges: end -->
